...
echo "   VPS_SSH_KEY = (paste the BASE64 below - recommended, avoids paste issues)"
echo ""
echo "   For base64 (recommended - single line, no paste issues):"
echo "   ─────────────────────────────────────"
cat "$KEY_PATH" | base64 -w 0
echo ""
echo "   ─────────────────────────────────────"
echo ""
echo "   Or raw key (copy exactly, all lines):"
echo "   ─────────────────────────────────────"
cat "$KEY_PATH"
echo "   ─────────────────────────────────────"
echo ""
echo "3. Prefer the base64 value (one long line) for VPS_SSH_KEY"
echo ""
